...
import dev.bestzige.manager.MySQLData;
...
public class AppSQL {
    ...
    private static final MySQLData mySQLDataManager = new MySQLData();
    static List<User> users = mySQLDataManager.getAllUsers();
    static List<Redeem> redeems = mySQLDataManager.getAllRedeems();
    ...
    private static void newUser() {
        ...
        mySQLDataManager.createUser(newUser);
    ...
    private static void generateRedeemCode() {
        ...
        mySQLDataManager.createRedeem(newRedeem);
    ...
    private static void useRedeemCode(User currentUser) {
        ...
        String message = mySQLDataManager.useRedeem(currentRedeem, currentUser);
